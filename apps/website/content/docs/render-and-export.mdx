...
Photos, videos, shapes and stickers from the Elements tab, and their In, Out and Loop animation,
export exactly as the desktop preview shows them: shapes and titles are drawn for the preview by
the render engine's own code. When you use Pexels media or stickers, the export dialog's
**Credits** list what to credit in your video's description.
