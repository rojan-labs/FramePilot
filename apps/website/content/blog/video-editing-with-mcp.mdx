...
Applied to video, an MCP server exposes editing operations (trim, split, add captions, render) so an agent can perform real edits on a real timeline. It doesn't generate a throwaway clip, it modifies *your* project.
