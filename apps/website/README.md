...
> **In progress:** the reading routes (blog, docs, changelog, legal) and the pricing and download pages still use the legacy `.eyebrow-tc` shim in `globals.css` and have not had their redesign pass. Remove the shim when they do.
