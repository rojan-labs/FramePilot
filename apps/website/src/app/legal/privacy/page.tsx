  ...
  return (
    <article className="container-x max-w-[820px] py-14 sm:py-20">
      ...
      <div className="prose-fp mt-9">
        ...
        <h2>Photos &amp; videos (Pexels)</h2>
        <p>
          If you search Elements → Photos or Videos, only the words you type are sent to{' '}
          <a href="https://www.pexels.com" target="_blank" rel="noopener noreferrer">
            Pexels
          </a>
          , using an API key you supply — nothing from your project, and no identifier we add. Files
          you add are downloaded to your device and become ordinary project files, so the project
          keeps working offline. Your own media is never sent anywhere as part of this.
        </p>
