...
const TOOL_META: Record<string, ToolMeta> = {
  ...
  remove_filler_words: { label: 'Remove filler words', Icon: AudioLines },
  ...
  check_caption_legibility: { label: 'Check captions read', Icon: Captions },
  ...
  tighten_clips: { label: 'Tighten pacing', Icon: Gauge },
  ...
  reorder_clips: { label: 'Reorder clips', Icon: ArrowLeftRight },
