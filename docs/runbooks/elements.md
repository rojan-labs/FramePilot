...
| "Preview approximate" on shapes                                           | the browser build without the engine (EL11)                                                | expected; the export is exact                                                                                           |
...
| Export slower with many elements                                          | per-frame compositing                                                                      | budget 1.3× with 20 elements (PX5 `scale-elements`); trim or remove elements the moment does not need                   |
