...
| Default / empty             | Short prompt describing what to search for, and the Pexels attribution link. No spinner, no auto-search.                                             |
| Photos / Videos             | `Segmented` control (the component Settings already uses). Switching kinds re-searches; it does not clear the query.                                 |
