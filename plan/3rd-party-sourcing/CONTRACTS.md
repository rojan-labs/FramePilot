...
| Default / empty             | Browses the provider catalogue (Openverse answers without a `q`), labelled as such, with the search prompt beside it. An empty box is a browse, not a blank panel.                     |
