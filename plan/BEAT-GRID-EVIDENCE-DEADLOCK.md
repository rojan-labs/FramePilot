...
## Validation run — every check `.github/workflows/ci.yml` gates on

| CI step                     | Command                                             | Result                                                                                                                                                                                                                                                   |
| --------------------------- | --------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| node-quality                | `pnpm typecheck`                                    | 17/17 tasks                                                                                                                                                                                                                                              |
| node-quality                | `pnpm lint`                                         | Clean per package. The **whole-repo** invocation OOMs the linter — reproduced on `main` at `ad5a1b0`, so it is a pre-existing tooling limit, not this change.                                                                                            |
| node-quality                | `pnpm exec turbo run test:coverage --concurrency=4` | 17/17 tasks — this is CI's real test gate, not plain vitest                                                                                                                                                                                              |
| node-quality                | `pnpm format:check`                                 | **Commented out in CI.** The three files this branch authored are formatted; the files it only edits were already prettier-dirty on `main` (verified in a worktree of `ad5a1b0`), so reformatting them would churn unrelated lines against CLAUDE.md §6. |
| python-engine               | `pnpm engine:test`                                  | 2696 passed, 1 skipped                                                                                                                                                                                                                                   |
| python-engine               | `pnpm engine:lint` / `engine:typecheck`             | ruff clean; mypy clean, 207 files                                                                                                                                                                                                                        |
| e2e                         | `pnpm test:e2e`                                     | 83 passed                                                                                                                                                                                                                                                |
| visual                      | `pnpm --filter @framepilot/e2e test:visual`         | 7 passed                                                                                                                                                                                                                                                 |
| license                     | `pnpm license:scan`                                 | 7 packages, no denylisted licenses (no dependency added)                                                                                                                                                                                                 |
| professional-rendered-evals | `pnpm eval:professional:rendered`                   | 33 rendered proofs pass (real MoviePy/FFmpeg)                                                                                                                                                                                                            |
| desktop-build               | `pnpm build`                                        | 10/10 tasks                                                                                                                                                                                                                                              |
| —                           | `pnpm eval:agent:foundation:real`                   | **Not run.** `workflow_dispatch` only; it drives real, billed Google Gemini calls and is deliberately not a push/PR gate.                                                                                                                                |

Package-level totals for the changed package: **3721 ai-sdk tests pass**, 1 skipped.

One flake worth naming: a single `pnpm test` invocation failed in `@framepilot/web-editor`
and did not reproduce — 2617/2617 on four subsequent runs, and this branch touches no
web-editor source.
