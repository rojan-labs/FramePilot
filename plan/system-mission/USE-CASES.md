...
| UC-08 | **Refine an existing edit** | after UC-01: "tighten the middle, keep the ending" | Edit modifies the existing timeline, does not restart it (briefing + commit ledger — the wipe guard was removed, ADR 0166), remembers prior decisions; call count ≤ first turn | P1.4, P1.5, P4.3; P9.1 | `[ ]` |
