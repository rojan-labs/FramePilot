...
| 4 | [`04-EDITING-QUALITY-AND-VERIFICATION.md`](./04-EDITING-QUALITY-AND-VERIFICATION.md) | Semantic operations; bounded verify loop; a graded scenario suite | 1, 3 | none | `[~]` 4/5 · 1 partial — verify loop, semantic ops, score floor and CI gate; P4.1 awaits its last rubric point |
