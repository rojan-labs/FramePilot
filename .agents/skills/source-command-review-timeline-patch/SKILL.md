---
name: 'source-command-review-timeline-patch'
description: 'Review a proposed timeline patch for validity, reversibility, and correctness before apply (PRD §8.5, §8.6)'
---

# source-command-review-timeline-patch

Use this skill when the user asks to run the migrated source command `review-timeline-patch`.
