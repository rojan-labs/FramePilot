...
Target duration, mapped speech, hook/payoff, protected moments, and platform frame.
...
Lock hook/payoff → remove dead material → assess duration/information gaps → add only motivated framing/speed changes → regenerate captions → watch opening and ending.

## Common mistakes

Deleting every breath, identical shot lengths, punch-ins every other cut, speeding punchlines, or captioning before structure settles.
