...
const TOOL_VERBS: Record<string, string> = {
  ...
  add_transitions: 'Deciding what belongs at each cut',
  match_color: 'Matching colour on',
  normalize_exposure: 'Evening out exposure on',
  apply_look: 'Applying a look to',
  add_mask: 'Masking',
